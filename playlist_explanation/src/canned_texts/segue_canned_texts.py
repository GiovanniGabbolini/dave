...
from src.out.get_value_musicbrainz import get_artist_type, get_area_value, get_label_value, get_recording_title, get_artist_name, get_event_name, get_event_type, get_work_type, get_work_title, get_release_title, get_release_group_title, get_place_type, get_place_name, get_recording_artist, get_release_artist, get_release_group_artist
    ...
    'equal': {
        ...
        ('release_group_musicbrainz_id', 'release_group_musicbrainz_id'): {
            ('release_group_id', 'artist_relationships'): {
                'text': lambda n1, n2, d: f"That was {artist_name(n1)}'s {album_name_n1}, {artist_relationships_line(get_release_group_title(n1['value']), 'album', n1, n2, d, 's')}"
            },
...
_short_atomic = {
    'equal': {
        ...
        ('artist_musicbrainz_id', 'artist_musicbrainz_id'): {
            ...
            ('artist_musicbrainz_id', 'artist_relationships'): {
                'text': lambda n1, n2, d: f"And now {artist_name(n2)}, who {d['phrase_n2']} {artist_name(n1)}{dots()}",
            },
            ('artist_relationships', 'artist_musicbrainz_id'): {
        ...
        ('release_group_musicbrainz_id', 'release_group_musicbrainz_id'): {
            ...
            ('release_group_id', 'artist_relationships'): {
                'text': lambda n1, n2, d: f"That was {artist_name(n1)}'s {album_name_n1}, {artist_relationships_short(get_release_group_title(n1['value']), 'album', n1, n2, d, 's')}{dots()}"
            },
            ('artist_relationships', 'release_group_id'): {
